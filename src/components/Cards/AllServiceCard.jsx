...
const PreviousButton = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute right-[70px] md:right-[150px] top-[490px] md:top-[520px] transform -translate-y-1/2 md:translate-y-0"
  >
...
const NextButton = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute right-[20px] md:right-[100px] top-[490px] md:top-[520px] transform -translate-y-1/2 md:translate-y-0"
  >
...
const AllServiceCard = () => {
  ...
  return (
    <div>
      <Slider {...settings} className="py-8 md:py-2 overflow-x-hidden">
        <ServiceCard
          img={Decoration}
          title="Decoration"
