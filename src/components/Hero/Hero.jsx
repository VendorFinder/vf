...
const Hero = () => {
  return (
    <div className="bg-home-hero h-screen md:h-screen bg-center py-5 md:py-0 pt-0 md:pt-10 bg-cover flex flex-col justify-center md:items-center">
      <h1
        className="font-sans text-heading-4 md:text-heading-2 text-neutral md:text-center
       px-4 md:px-0 pt-12 md:pt-40 pb-10 md:pb-20 font-[700]"
      >
